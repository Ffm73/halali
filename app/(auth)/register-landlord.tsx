...
type RegistrationStep = 'personal' | 'preferences' | 'payment' | 'verification';
...
export default function RegisterLandlordScreen() {
  ...
  const handleNextStep = () => {
    if (currentStep === 'personal') {
      const displayName = preferences.language === 'ar' ? personalInfo.fullNameAr : personalInfo.fullNameEn;
  ...
  const handleRegister = async () => {
    ...
    try {
      console.log('🏢 LANDLORD REGISTRATION: Starting registration process...');
      ...
      if (result.success) {
        console.log('✅ LANDLORD REGISTRATION SUCCESSFUL - Should redirect to landlord portal');
        Alert.alert(
          ...
          [
            {
              ...
              onPress: () => {
                console.log('🎯 LANDLORD: Navigating to landlord portal');
                router.replace('/(tabs)');
              },
            },
          ]
        ...
        console.log('❌ LANDLORD REGISTRATION FAILED:', result.error);
        Alert.alert(
  ...
  const renderPersonalStep = () => (
    <View style={styles.stepContainer}>
      <View style={[styles.stepHeader, { alignItems: isRTL ? 'flex-end' : 'flex-start' }]}>
        ...
        >
          {language === 'ar' ? 'أدخل معلوماتك الأساسية لإنشاء حساب المالك' : 'Enter your basic information to create owner account'}
        </Text>
      </View>
  ...
  const renderPreferencesStep = () => (
    <View style={styles.stepContainer}>
      <View style={[styles.stepHeader, { alignItems: isRTL ? 'flex-end' : 'flex-start' }]}>
        ...
        >
          {language === 'ar' ? 'اختر اللغة والعملة المفضلة لحسابك' : 'Choose your preferred language and currency'}
        </Text>
      </View>
  ...
  const renderPaymentStep = () => (
    <View style={styles.stepContainer}>
      <View style={[styles.stepHeader, { alignItems: isRTL ? 'flex-end' : 'flex-start' }]}>
        ...
        >
          {language === 'ar' ? 'أضف طرق الدفع التي سيستخدمها المستأجرون' : 'Add payment methods that tenants will use'}
        </Text>
      </View>
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput
          ...
          onChangeText={(text) => setPaymentMethods(prev => ({ ...prev, bankName: text }))}
        />
      </View>
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput
          ...
          onChangeText={(text) => setPaymentMethods(prev => ({ ...prev, iban: text.toUpperCase() }))}
        />
      </View>
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput
          ...
          placeholder={language === 'ar' ? 'أحمد محمد العلي' : 'Ahmed Mohammed Ali'}
          placeholderTextColor={colors.textMuted}
          value={paymentMethods.accountName}
          onChangeText={(text) => setPaymentMethods(prev => ({ ...prev, accountName: text }))}
        />
      </View>
      ...
      <View style={styles.inputGroup}>
        ...
        >
          {language === 'ar' ? 'رقم STC Pay (اختياري)' : 'STC Pay Number (Optional)'}
        </Text>
        <TextInput
          style={[
            styles.textInput,
          ...
          placeholderTextColor={colors.textMuted}
          value={paymentMethods.stcPayNumber}
          onChangeText={(text) => setPaymentMethods(prev => ({ ...prev, stcPayNumber: text }))}
  ...
  const getStepProgress = () => {
    const steps = ['personal', 'preferences', 'payment', 'verification'];
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={[styles.header, { alignItems: isRTL ? 'flex-end' : 'flex-start' }]}>
          ...
          >
            {language === 'ar' ? 'حساب مالك عقار' : 'Property Owner Account'}
          </Text>
        </View>
